...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-25 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-5 rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95 group"
    >
