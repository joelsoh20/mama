...
import { Autoplay, FreeMode } from 'swiper/modules'; // On utilise FreeMode
...
<section className="py-32 bg-[#f3f1eb] overflow-hidden">
  <div className="max-w-7xl mx-auto px-6">
    ...
    {/* Slider de créations en mode LIBRE */}
    <Swiper
  ...
  freeMode={{
    enabled: true,
    sticky: false,
    momentum: true, // Permet de "lancer" le slide
  }}
  loop={true}
  autoplay={{
    delay: 1, // On garde le mouvement continu
    disableOnInteraction: false, 
    pauseOnMouseEnter: true, // CRUCIAL : Arrête l'auto-animation au survol pour laisser la souris diriger
  }}
  speed={6000}
  // Ajoute ceci pour forcer la réponse au toucher/souris
...
>
  ...
  {/* Nettoyage total des styles de pagination */}
  <style dangerouslySetInnerHTML={{ __html: `
    .creations-swiper-clean .swiper-wrapper {
      transition-timing-function: linear !important; /* Mouvement fluide constant */
    }
    /* Suppression visuelle de tout indicateur Swiper résiduel */
